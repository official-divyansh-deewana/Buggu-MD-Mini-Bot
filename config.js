...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+918882829982', // Mettez votre numéro ici
    BOT_NAME: "BUGGU MD Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᗿ᎑ԍԍ᎑-ᴍᴅ',
    ...
    AUTO_RECORDING: process.env.AUTO_RECORDING || 'true', // Afficher "Enregistre..."
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/DyiDSuY2ChdJQE6GCWzCH6',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.ibb.co/tT1Z8nV6/x.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb0dS3e3bbV4T5EGDu1q',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8339780715:AAGA0uzZKFzd3DmL8QlhJkqezXGYkP67pbw',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '2031314339'
