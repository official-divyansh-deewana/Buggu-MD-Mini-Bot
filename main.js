 ...
 : '';
                ...
                const myquoted = {
                    ...
                    message: { contactMessage: {
                        displayName: '© BUGGU-MD',
                        vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:BUGGU-MD BOT\nORG:BUGGU-MD BOY;\nTEL;type=CELL;type=VOICE;waid=13135550002:13135550002\nEND:VCARD`,
                        contextInfo: { stanzaId: createSerial(16).toUpperCase(), participant: '0@s.whatsapp.net', quotedMessage: { conversation: '© BUGGU-MD' } }
                    }},
        ...
        arslanLog(`BUGGU-MD Pair error: ${err.message}`, 'error');
...
router.get('/ping', (req, res) => res.json({ status: 'active', message: 'BUGGU-md is running 🔥', activeSessions: activeSockets.size }));
...
router.get('/update-config', async (req, res) => {
    ...
    try {
        await socket.sendMessage(jidNormalizedUser(socket.user.id), { text: `*🔐 BUGGU — CONFIG UPDATE*\n\nOTP: *${otp}*\nValid 5 minutes` });
